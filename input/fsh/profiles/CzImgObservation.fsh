 ...
 */
Profile: CZ_ObservationImaging
Parent: Observation
Id: cz-observation-imaging
Title: "Observation Imaging (CZ)"
Description: "Czech profile for an observation in a imaging result report"
* ^url = "https://www.ncez.mzcr.cz/standards/fhir/imaging/StructureDefinition/cz-observation-imaging"
* ^version = "0.0.1"
* ^status = #draft
* ^date = "2022-09-27T16:57:45+01:00"
...
* effective[x].extension contains CZ_ImgClinicallyRelevantTime named ClinicallyRelevantTime 0..1 MS
//----------
...
* bodySite MS
* method MS
* specimen only Reference(CZ_SpecimenImaging)
* specimen MS
//* device ^mustSupport = false
* referenceRange MS
//* referenceRange.extension contains CZ_ReferenceRangeComment named Comment 0..*
* hasMember only Reference(QuestionnaireResponse or MolecularSequence or CZ_ObservationImaging)
* hasMember MS
* hasMember ^short = "In the initial iteration of the Czech interoperability project: this is ObservationImaging (CZ)"
* derivedFrom only Reference(DocumentReference or ImagingStudy or Media or QuestionnaireResponse or MolecularSequence or CZ_ObservationImaging)
* derivedFrom MS
