Profile: CZ_ImagingResultReport
Parent: DiagnosticReport
Id: cz-imaging-result-report
Title: "Imaging Result Report (CZ)"
Description: "Czech profile for an imaging result report"
* ^url = "https://www.ncez.mzcr.cz/standards/fhir/imaging/StructureDefinition/cz-imaging-result-report"
* ^version = "0.0.1"
* ^status = #draft
...
* category from CZ_ImgResultReportTypesVS (preferred)
 ...
 */
* code MS
* code from CZ_ImgStudyTypesVS (preferred)
...
* performer ^definition = "The diagnostic service that is responsible for issuing the report. In the imaging result report, this is typically an organization (i.e. the radiology)\r\nNote the Observation MAY have a different performer."
...
* specimen MS
* result only Reference(CZ_ObservationImaging)
* result MS
* media MS
* conclusion MS
* conclusionCode MS
